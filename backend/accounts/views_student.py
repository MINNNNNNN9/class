...
from .models import Profile, StudentCourse
...
def get_credit_summary(request):
    ...
    try:
        ...
        total_general = sum([sc.course.credits for sc in historical_courses if sc.course.course_type in ['general_required', 'general_elective']])
        ...
        semester_general = sum([sc.course.credits for sc in semester_courses if sc.course.course_type in ['general_required', 'general_elective']])
